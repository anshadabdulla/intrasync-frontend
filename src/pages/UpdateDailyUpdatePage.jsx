...
import UpdateDailyUpdateForm from '../components/UpdateDailyUpdateForm';
import '../assets/styles/homePage.css';

const UpdateDailyUpdatePage = () => {
        ...
        <div className="layout-container" ref={layoutRef}>
            ...
            <div className={`dashboard-container ${isSidebarOpen ? 'shrink' : ''}`}>
                ...
                <div className="page-content">
                    <UpdateDailyUpdateForm
                        onSuccess={() => navigate('/daily-updates-list')}
                        onClose={() => navigate('/daily-updates-list')}
                    />
                </div>
            </div>
...
export default UpdateDailyUpdatePage;
